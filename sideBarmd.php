...
<body class="!bg-transparent">
    <div class="flex" id="mainSide">
        <div class="h-[100vh] shrink-0 !w-[256px] overflow-hidden bg-[var(--accent)]" id="sidebar">
            ...
            <ul>
                ...
                <li class="iconOnly">
                    <a href="logs.php" class="flex items-center gap-2 p-2 hover:bg-sidebar-primary hover:text-sidebar-primary-foreground rounded">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-bar-chart3">
                ...
                <li class="iconOnly">
                    <a href="issues.php" class="flex items-center gap-2 p-2 hover:bg-sidebar-primary hover:text-sidebar-primary-foreground rounded">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="w-[100%] h-screen" id="disableBar" style="backdrop-filter: blur(2px);"></div>
    </div>
    ...
    <script>
        ...
        const disableBar = document.getElementById("disableBar");
        ...
        document.getElementById("disableBar").addEventListener("click", () => {
            if (mainSide.style.display === "none" || mainSide.style.display === "") {
        ...
        // Close sidebar when clicking on a menu item (mobile behavior)
        document.querySelectorAll('li.iconOnly a').forEach(link => {
